...
std::string default_data = "/dune/data2/users/drivera/ProtoDUNE/Prod3/pionana_Prod3_5387_1GeV_7_30_20.root";
//std::string default_mc = "/dune/data2/users/drivera/ProtoDUNE/MCC12/pionana_mc_1GeV_6_30_20.root";
//std::string default_mc = "/dune/data2/users/drivera/ProtoDUNE/Prod3/pionana_Prod3_mc_1GeV_7_30_20.root";
std::string default_mc = "/dune/data2/users/drivera/ProtoDUNE/Prod3/pionana_Prod3_mc_1GeV_9_18_20.root";
...
int eventSelection(const string mcFile = default_mc, const string dataFile = default_data,
  ...
  auto mc_all = frame
    ...
    // -- D.R.
    .Define("reco_beam_allTrack_proton_pvalue", compute_pvalue,
            {"reco_beam_allTrack_Chi2_proton", "reco_beam_allTrack_Chi2_ndof" })

    // -- D.R.
    .Define("reco_daughter_allTrack_proton_pvalue", compute_pvalues,
    ...
    // -- D.R.
    .Define("daughter_radial_distance", compute_radial_distance,
            /*{"reco_beam_trackDirX", "reco_beam_trackDirY", "reco_beam_trackDirZ",*/
            {"reco_beam_allTrack_trackEndDirX", "reco_beam_allTrack_trackEndDirY", "reco_beam_allTrack_trackEndDirZ",
             "reco_daughter_allTrack_startX", "reco_daughter_allTrack_startY",
             "reco_daughter_allTrack_startZ", "reco_daughter_allTrack_endX",
             "reco_daughter_allTrack_endY",  "reco_daughter_allTrack_endZ"})

    // -- D.R.
    .Define("daughter_rho", compute_rho,
            /*{"reco_beam_trackDirX", "reco_beam_trackDirY", "reco_beam_trackDirZ",*/
            {"reco_beam_allTrack_trackEndDirX", "reco_beam_allTrack_trackEndDirY", "reco_beam_allTrack_trackEndDirZ",
             "reco_beam_endX", "reco_beam_endY","reco_beam_endZ",
             "reco_daughter_allTrack_startX", "reco_daughter_allTrack_startY",
  ...
  mc_all = mc_all
    ...
    // -- D.R.
    .Define("prompt_NP_NeutronIDs", promptNP_IDs,
            {"true_beam_grand_daughter_PDG", "true_beam_grand_daughter_Process",
             "true_beam_grand_daughter_parID"})

    .Define("num_Prompt_Pi2NP", numPi2NP,
            {"true_primPionInel", "prompt_NP_NeutronIDs"})
