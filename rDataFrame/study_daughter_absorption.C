...
int study_daughter_absorption(const string path = inputFile){
   ...
   TFile *output = new TFile ("output_chex_study.root", "RECREATE");
...
*/
   THStack *stack_true_daughter_types = new THStack("n_true_daughter", "True MC ChEx Daughters");
   THStack *stack_true_daughter_startP = new THStack ("true_daughter_startP", "True MC ChEx Daughters Start P");
   THStack *stack_true_daughter_startE = new THStack ("true_daughter_startE", "True MC ChEx Daughters Start Energy");
   THStack *stack_true_daughter_len = new THStack ("true_daughter_len", "True MC ChEx Daughters Length");
   ...
   //THStack *stack_reco_daughter_IDmatch = new THStack("true_reco_daughter_match", "True Absorption Events, Reco Daughters matching true daughters");
   ...
   auto absorption_definitions = filter_trueChExProcess
  ...
  /* auto pion_daughter_reco_true = absorption_definitions
   ...
   auto hist_unmatched = absorption_definitions.Histo1D({"reco_unmatched", "0 = unmatched, 1 = primary, 2 = matched, 3 = (matched) is grand daughter",5,0,5}, "reco_good_daughter_IDmatch");

   auto h_reco_IDmatch_nucleus = absorption_definitions.Histo1D( {"reco_ID_nucleus", "nucleus", 5, 0, 5},"nucleus_IDmatch");
   auto h_reco_IDmatch_kaon = absorption_definitions.Histo1D({"reco_ID_kaon", "kaon", 5, 0, 5} ,"kaon_IDmatch");
   auto h_reco_IDmatch_muPlus = absorption_definitions.Histo1D({"reco_ID_muPlus", "muPlus", 5, 0, 5}, "muPlus_IDmatch");
   auto h_reco_IDmatch_muMinus = absorption_definitions.Histo1D( {"reco_ID_muMinus", "muMinus",  5, 0, 5},"muMinus_IDmatch");
   auto h_reco_IDmatch_gamma = absorption_definitions.Histo1D({"reco_ID_gamma", "gamma", 5, 0, 5},"gamma_IDmatch");
   auto h_reco_IDmatch_proton = absorption_definitions.Histo1D( {"reco_ID_proton", "proton", 5, 0, 5},"proton_IDmatch");
   auto h_reco_IDmatch_piPlus = absorption_definitions.Histo1D({"reco_ID_piPlus", "piPlus", 5, 0, 5},"piPlus_IDmatch");
   auto h_reco_IDmatch_piMinus = absorption_definitions.Histo1D({"reco_ID_piMinus", "piMinus",5, 0, 5},"piMinus_IDmatch");
   auto h_reco_IDmatch_electron = absorption_definitions.Histo1D({"reco_ID_electron", "electron", 5, 0, 5},"electron_IDmatch");
   ...
   auto hist_mc_vs_reco_proton = absorption_definitions
      /*
      .Define("grand_daughter_match", [](){return 3;})
      .Define("great_grand_daughter_match",[](){return 4;})
      .Define("n_gd_proton", count_type, {"grand_daughter_match", "proton_IDmatch"})
      ...
      .Define("n_reco_proton_noGD", "n_reco_true_proton - n_gd_proton - n_great_gd_proton")
      */
      .Histo2D({"n_protons_mcVsReco", "Absorption Events: N MC True Protons vs N Reco Protons (grand daughters found from matching subtracted)", 8, 0, 8, 8, 0, 8}, "n_reco_proton_noGD", "n_true_proton");
   ...
   auto hist_true_len_vs_startP_proton = absorption_definitions
      .Histo2D({"true_lenVsStartP_proton", "Absorption True Protons True Length vs startP", 13, 0., 1.3 , 35, 0., 150}, "proton_true_startP", "proton_true_len");
   ...
   auto hist_reco_true_len_vs_startP_proton = absorption_definitions
      .Histo2D({"reco_true_lenVsStartP_proton", "Absorption Reco-True Protons True Length vs startP", 13, 0., 1.3 , 35, 0., 150}, "proton_reco_true_startP", "proton_reco_true_len");
   ...
   auto hist_reco_true_len_vs_startP_proton_bin = absorption_definitions
      .Histo2D({"reco_true_lenVsStartP_proton_bin", "Absorption Reco-True Protons True Length vs startP", 13, 0., 1.3 , 81, 0., 80}, "proton_reco_true_startP", "proton_reco_true_len");
