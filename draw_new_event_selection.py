...
s2.GetXaxis().SetBinLabel(4, "APA3")
...
hMC_BG_Unmatched_vt.SetBinContent( 1, tMC.GetEntries( "vertex == 0 && matched && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3" ))
hMC_BG_Unmatched_vt.SetBinContent( 2, tMC.GetEntries( "vertex == 0 && matched && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection" ))
hMC_BG_Unmatched_vt.SetBinContent( 3, tMC.GetEntries( "vertex == 0 && matched && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && has_pi0_shower" ))
hMC_BG_Unmatched_vt.SetBinContent( 4, tMC.GetEntries( "vertex == 0 && matched && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && !has_pi0_shower" ))
...
hMC_BG_Unmatched_beam.SetBinContent( 1, tMC.GetEntries( "vertex == 0 && !matched && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3" ))
hMC_BG_Unmatched_beam.SetBinContent( 2, tMC.GetEntries( "vertex == 0 && !matched && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection" ))
hMC_BG_Unmatched_beam.SetBinContent( 3, tMC.GetEntries( "vertex == 0 && !matched && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && has_pi0_shower" ))
hMC_BG_Unmatched_beam.SetBinContent( 4, tMC.GetEntries( "vertex == 0 && !matched && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && !has_pi0_shower" ))
...
hMC_BG_Inelastic.SetBinContent( 1, tMC.GetEntries( "(vertex == 1 || vertex == 3) && !true_signal && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3" ))
hMC_BG_Inelastic.SetBinContent( 2, tMC.GetEntries( "(vertex == 1 || vertex == 3) && !true_signal && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection" ))
hMC_BG_Inelastic.SetBinContent( 3, tMC.GetEntries( "(vertex == 1 || vertex == 3) && !true_signal && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && has_pi0_shower" ))
hMC_BG_Inelastic.SetBinContent( 4, tMC.GetEntries( "(vertex == 1 || vertex == 3) && !true_signal && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && !has_pi0_shower" ))
...
hMC_BG_Elastic.SetBinContent( 1, tMC.GetEntries( "vertex == 2 && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3" ))
hMC_BG_Elastic.SetBinContent( 2, tMC.GetEntries( "vertex == 2 && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection" ))
hMC_BG_Elastic.SetBinContent( 3, tMC.GetEntries( "vertex == 2 && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && has_pi0_shower" ))
hMC_BG_Elastic.SetBinContent( 4, tMC.GetEntries( "vertex == 2 && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && !has_pi0_shower" ))
hMC_BG_Elastic.SetLineColor(kBlack)
hMC_BG_Elastic.SetFillColor(kBlack)


hMC_BG_Other = TH1D( "hMC_BG_Other", "Other", 4, 0, 4 )
hMC_BG_Other.SetBinContent( 1, tMC.GetEntries( "vertex == 4 && !true_signal && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3" ))
hMC_BG_Other.SetBinContent( 2, tMC.GetEntries( "vertex == 4 && !true_signal && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection" ))
hMC_BG_Other.SetBinContent( 3, tMC.GetEntries( "vertex == 4 && !true_signal && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && has_pi0_shower" ))
hMC_BG_Other.SetBinContent( 4, tMC.GetEntries( "vertex == 4 && !true_signal && passes_PID && passes_beam_type && passes_beam_cuts && ends_in_APA3 && signal_selection && !has_pi0_shower" ))
