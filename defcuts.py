...
def defcuts():
  cuts = {
    ...
    "PionInelToPiPlus":   "reco_beam_truth_Process == \"pi+Inelastic\" && reco_beam_truth_PDG == 211",
    "PionInelToKaon":     "reco_beam_truth_Process == \"pi+Inelastic\" && abs(reco_beam_truth_PDG) == 321",
    "PionInelToPiMinus":  "reco_beam_truth_Process == \"pi+Inelastic\" && reco_beam_truth_PDG == -211",
    "PionInelToProton":   "reco_beam_truth_Process == \"pi+Inelastic\" && reco_beam_truth_PDG == 2212",
    "PionInelToNuc":      "reco_beam_truth_Process == \"pi+Inelastic\" && reco_beam_truth_PDG  > 2212",
    "PionInelToGamma":    "reco_beam_truth_Process == \"pi+Inelastic\" && reco_beam_truth_PDG == 22",

    "UpstreamInt":        "(reco_beam_truth_Process == \"neutronInelastic\" ||  reco_beam_truth_Process == \"protonInelastic\" || reco_beam_truth_Process == \"pi-Inelastic\" || reco_beam_truth_Process == \"hadElastic\") && reco_beam_truth_origin == 4",
...
def testcuts(e):
  ...
  elif( e.reco_beam_truth_Process == "pi+Inelastic"  and e.reco_beam_truth_PDG == 211 ):
    return "PionInelToPiPlus"
  elif( e.reco_beam_truth_Process == "pi+Inelastic"  and e.reco_beam_truth_PDG == 321 ):
    return "PionInelToKaon"
  elif( e.reco_beam_truth_Process == "pi+Inelastic"  and e.reco_beam_truth_PDG == -211 ):
    return "PionInelToPiMinus" 
  elif( e.reco_beam_truth_Process == "pi+Inelastic"  and e.reco_beam_truth_PDG == 2212 ):
    return "PionInelToProton"
  elif( e.reco_beam_truth_Process == "pi+Inelastic"  and e.reco_beam_truth_PDG  > 2212 ):
    return "PionInelToNuc" 
